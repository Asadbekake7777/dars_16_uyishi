      ...
      bottomNavigationBar: const BottomAppBar(
        child: Row(
          ...
          children: [
            Column(
              children: [
                Icon(Icons.home_filled, color: Colors.blue, size: 25),
                Text(
                  "Home",
                  style: TextStyle(color: Colors.blue, fontSize: 15, height: 1),
                )
              ],
            ),
            Column(
              children: [
                ...
                Text(
                  "Schedule",
                  style: TextStyle(color: Colors.grey, fontSize: 15, height: 1),
                )
              ],
            ),
            Column(
